  ...
  meta: [
    {
      name: "description",
      content:
        "API Technology provides a range of business to business services in Web, Mobile, Networking, ICT and Electronics Hardware areas.",
    },
  ],
});
...
<template>
  <LazyLayoutPageSection title="Our Services" />
  <v-container>
    <v-row class="py-16">
      <v-col cols="12" md="6">
